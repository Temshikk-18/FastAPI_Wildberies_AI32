...
Revision ID: 005a66838c42
Revises: 
Create Date: 2026-07-07 14:13:46.166172
...
def upgrade() -> None:
    ...
    sa.Column('category_image', sa.String(length=32), nullable=False),
    ...
    sa.Column('chose_size', sa.Enum('S', 'M', 'XL', 'XXL', 'XXXL', name='sizechoices'), nullable=False),
